...
#define ENABLE_RGB_MATRIX_SOLID_REACTIVE_CROSS_SOLID_BACKGROUND
#define ENABLE_RGB_MATRIX_SOLID_REACTIVE_MULTICROSS_SOLID_BACKGROUND
...
#if !defined(HSV_DEFAULT_INCREMENT)
#define HSV_DEFAULT_INCREMENT 40
#endif

#if !defined(HSV_ANIMTATION_BACKGROUND_DEFAULT_HUE)
#define HSV_ANIMATION_BACKGROUND_DEFAULT_HUE 170
#endif

#if !defined(HSV_ANIMTATION_BACKGROUND_DEFAULT_SAT)
#define HSV_ANIMATION_BACKGROUND_DEFAULT_SAT 255
#endif

#if !defined(HSV_ANIMTATION_BACKGROUND_DEFAULT_VAL)
#define HSV_ANIMATION_BACKGROUND_DEFAULT_VAL 255
#endif
